...
<aside id="sidebar"
    ...
    <div class="flex h-16 items-center justify-between border-b border-white/10 px-4">
        ...
        <button onclick="toggleSidebar()"
            ...
            <svg id="toggleIcon" class="h-3.5 w-3.5 transition-transform duration-300" fill="none" viewBox="0 0 24 24"
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <?php if ($role === 'admin' || $role === 'hr'): ?>
            ...
            <a href="/laporan"
                ...
                <svg class="h-[18px] w-[18px] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                    stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <?php if ($role === 'admin'): ?>
                ...
                <a href="<?= BASE_URL ?>views/divisi/index.php"
                    class="nav-item flex items-center gap-3 rounded-xl px-3 py-2 text-white/70 hover:bg-white/10 hover:text-white">
                    <svg class="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="<?= BASE_URL ?>views/posisi/index.php"
                    class="nav-item flex items-center gap-3 rounded-xl px-3 py-2 text-white/70 hover:bg-white/10 hover:text-white">
                    <svg class="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?= BASE_URL ?>views/skill/index.php"
                    class="nav-item flex items-center gap-3 rounded-xl px-3 py-2 text-white/70 hover:bg-white/10 hover:text-white">
                    <svg class="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <?php if ($role === 'candidate'): ?>
            ...
            <a href="/lamaran-saya"
                ...
                <span
                    class="nav-badge sidebar-text ml-auto rounded-full bg-amber-500 px-2 text-[10px] font-bold text-white">
                    8
                </span>
            </a>
            ...
            <a href="/interview-saya"
                ...
                <span class="sidebar-text">Jadwal Interview</span>
                <span
                    class="nav-badge sidebar-text ml-auto rounded-full bg-green-500 px-2 text-[10px] font-bold text-white">
                    2
                </span>
            </a>
            ...
            <a href="<?= BASE_URL ?>views/candidate/profile.php?id?=<?= $_SESSION['user_id'] ?>"
                class="nav-item flex items-center gap-3 rounded-xl px-3 py-2 text-white/70 hover:bg-white/10 hover:text-white">
                <svg class="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
